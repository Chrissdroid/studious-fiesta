            ...
            <div class="container">
                ...
                <div class="text-center">
                    ...
                    <ul class="list-inline">
                        <li class="list-inline-item"><a class="btn btn-outline-secondary" href="./regions.php">Régions</a></li>
                ...
                <div class="row g-2">
                    <a href="" class="btn btn-light col-12">Connexion</a>
                    <a href="" class="btn btn-light col-12">Inscription</a>
                </div>
            </div>
        </nav>
